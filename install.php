 ...
 *
 * Ejecutar UNA SOLA VEZ desde la línea de comandos, desde el directorio branch2/:
 *
 *   php install.php
 *
 * NO debe ser accesible desde el servidor web. Colócalo en branch2/ (fuera de public/).
