    ...
    private function initializeTables() {
        ...
        foreach ($statements as $sql) {
            try {
                ...
                // Solo ignorar "ya existe" (42P07 = tabla duplicada, 42723 = secuencia/función duplicada).
                // Cualquier otro error (permisos, tipo incorrecto, etc.) se propaga.
                $sqlstate = $e->getCode();
                if ($sqlstate !== '42P07' && $sqlstate !== '42723') {
                    throw $e;
                }
            }
        }
