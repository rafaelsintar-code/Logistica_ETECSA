...
try {
    ...
    $vale      = isset($data['vale']) && $data['vale'] !== null ? (int)$data['vale'] : null;
    $valeMostrar = $vale !== null ? $vale : '—';
    $valeArchivo = $vale !== null ? $vale : 'pendiente';
    ...
    $almacen = $codAlm[0] === '0' ? 'C001' : $codAlm;
    ...
    $sheet->setCellValue("J$pie2", $valeMostrar);
    ...
    echo json_encode([
        ...
        "filename" => "{$nombrePV}_vale{$valeArchivo}.xlsx"
    ]);
